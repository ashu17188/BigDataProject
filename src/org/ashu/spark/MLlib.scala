...
object MLlib {
  ...
  def main(args: Array[String]) {
    ...
    val spam = sc.textFile("/home/hduser/BigData_Workspace/BigDataProject/resources/data/spam.txt")
    val ham = sc.textFile("/home/hduser/BigData_Workspace/BigDataProject/resources/data/ham.txt")
