...
import org.ashu.java.ApacheAccessLog
 ...
 */
case class Config(WindowLength: Int = 3000, SlideInterval: Int = 3000, LogsDirectory: String = "/tmp/logs",
  CheckpointDirectory: String = "/tmp/checkpoint",
  OutputHTMLFile: String = "/home/hduser/BigData_Workspace/BigDataProject/resources/output/log_stats.html",
  OutputDirectory: String = "/home/hduser/BigData_Workspace/BigDataProject/resources/output/ooutpandas",
  IndexHTMLTemplate :String ="/home/hduser/BigData_Workspace/BigDataProject/resources/output/index.html.template") {
...
object LogAnalyzerAppMain {
  ...
  def main(args: Array[String]) {
    val parser = new OptionParser[Config]("LogAnalyzerAppMain") {
