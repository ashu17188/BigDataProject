...
object RecoverableNetworkWordCount {
  ...
  //    () => createContext(ip, port, outputPath, checkpointDirectory))
     () => createContext("127.0.0.1", 8080, "/home/hduser/BigData_Workspace/BigDataProject/resources", "/home/hduser/BigData_Workspace/BigDataProjecWordBlacListt/resources/WordBlacList"))
        ssc.start()
