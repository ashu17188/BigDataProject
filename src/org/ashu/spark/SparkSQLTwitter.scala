...
object SparkSQLTwitter {
    def main(args: Array[String]) {
      ...
      val inputFile = "/home/hduser/BigData_Workspace/BigDataProject/resources/data/testweet.json"
      val outputFile = "/home/hduser/BigData_Workspace/BigDataProject/resources/data/testweetOutput"
      ...
      setMaster("local").setAppName("SparkSQLTwitter")
